...
public class MouvementFouTests
{
    ...
    public void OneTimeSetup()
    {
        ...
        fouPrefab = AssetDatabase.LoadAssetAtPath<GameObject>("Assets/Prefabs/Pieces/Chess Bishop White.prefab");
    }
    [UnitySetUp]
    ...
    public void CaseContientPieceApresAvoirSetLaPiece()
    {
        ...
        FousComportement fou = fouPrefab.GetComponent<FousComportement>();
